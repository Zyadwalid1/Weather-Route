...
async function weatherAPIByRequest(
  ...
  const getWeatherData = await fetch(
    `https://api.weatherapi.com/v1/${requiredData}.json?key=544166733cf346ca962191713232612&q=${latitude},${longitude}&days=3&lang=${language}`
  );
...
async function weatherAPIBySearch(search) {
  const getWeatherData = await fetch(
    `https://api.weatherapi.com/v1/search.json?key=544166733cf346ca962191713232612&q=${search}`
  );
  response = await getWeatherData.json();
